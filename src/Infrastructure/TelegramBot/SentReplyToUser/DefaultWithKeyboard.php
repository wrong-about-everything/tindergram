...
class DefaultWithKeyboard implements SentReplyToUser
{
    ...
    public function __construct(InternalTelegramUserId $telegramUserId, MessageToUser $messageToUser, KeyboardButtons $keyboardButtons, HttpTransport $httpTransport)
    {

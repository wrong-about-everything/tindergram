...
use TG\Domain\Pair\WriteModel\FirstSentPairAfterRegistrationIfExistsNoCandidatesYetOtherwise;
...
class NextReplyToUser implements MessageSentToUser
{
    ...
    {
        return
            (new FirstSentPairAfterRegistrationIfExistsNoCandidatesYetOtherwise(

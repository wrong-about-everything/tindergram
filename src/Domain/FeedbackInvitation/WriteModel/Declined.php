...
use RC\Domain\FeedbackInvitation\Status\Pure\Declined as DeclinedStatus;
...
class Declined implements FeedbackInvitation
{
...
q
                ,
                [(new DeclinedStatus())->value(), $this->feedbackInvitationId->value()->pure()->raw()],
                $this->connection
            ))
                ->response();

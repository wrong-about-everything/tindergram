...
use Exception;
use TG\Domain\BotUser\Preferences\Impure\FromBotUser;
...
use TG\Domain\RegistrationQuestion\RegistrationQuestionId\Pure\FromRegistrationQuestion;
...
class AnswerTo implements RegistrationQuestionAnswer
{

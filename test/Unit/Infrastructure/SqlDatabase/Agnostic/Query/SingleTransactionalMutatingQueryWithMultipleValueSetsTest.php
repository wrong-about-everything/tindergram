...
use RC\Infrastructure\SqlDatabase\Agnostic\Query\SingleTransactionalMutatingQueryWithMultipleValueSets;
use RC\Tests\Infrastructure\Environment\Reset;

class SingleTransactionalMutatingQueryWithMultipleValueSetsTest extends TestCase
{
    ...
    public function testSuccessfulUpdate()
    {
        ...
        $result =
            (new SingleTransactionalMutatingQueryWithMultipleValueSets(
